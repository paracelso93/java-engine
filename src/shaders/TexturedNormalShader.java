...
import shaders.uniforms.AttenuationUniform;
import shaders.uniforms.MaterialUniform;
import shaders.uniforms.PointLightUniform;

public class TexturedNormalShader extends Program {
    private static final String vertexSource = "src/shaders/sources/shader_normal.vert";
    private static final String fragmentSource = "src/shaders/sources/shader_normal.frag";

    private int transformLocation, mvpLocation, viewLocation, ambientLocation;
    ...
    public void addUniforms(Matrix4f transform,
        ...
        this.view = view;
        this.ambientColor = light.getColor();
    ...
    protected void getAllUniforms() {
        ...
        ambientLocation = getUniformLocation("ambient_light");
    ...
    public void loadAllUniforms() {
        ...
        loadVec3(ambientLocation, ambientColor);
        loadFloat(specularPowerLocation, PointLight.SPECULAR_POWER);
